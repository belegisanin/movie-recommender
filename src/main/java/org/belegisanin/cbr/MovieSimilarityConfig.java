...
import org.belegisanin.cbr.similarity.ListOverlapSimilarity;
...
public class MovieSimilarityConfig {
    ...
    public static NNConfig getConfig() {
        ...
        simConfig.addMapping(new Attribute("genres", MovieDescription.class), new ListOverlapSimilarity());
        simConfig.addMapping(new Attribute("director", MovieDescription.class), new Equal());
        simConfig.addMapping(new Attribute("actors", MovieDescription.class), new ListOverlapSimilarity());
